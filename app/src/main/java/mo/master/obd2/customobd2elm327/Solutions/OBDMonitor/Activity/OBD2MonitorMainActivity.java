...
import mo.master.obd2.customobd2elm327.Solutions.OBDMonitor.Service.OBD2MonitorService;

public class OBD2MonitorMainActivity extends AppCompatActivity {
...
//                sendCMDMessage(writeMessage);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCommandsSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
